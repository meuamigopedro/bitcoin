...
AddrInfo* AddrMan::Impl::Find(const CNetAddr& addr, int* pnId)
{
    AssertLockHeld(cs);
...
AddrInfo* AddrMan::Impl::Create(const CAddress& addr, const CNetAddr& addrSource, int* pnId)
{
    AssertLockHeld(cs);
...
void AddrMan::Impl::MakeTried(AddrInfo& info, int nId)
{
    AssertLockHeld(cs);
