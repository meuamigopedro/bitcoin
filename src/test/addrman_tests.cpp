...
BOOST_AUTO_TEST_CASE(addrman_select)
{
    ...
    BOOST_CHECK_EQUAL(addrman->Select(/*newOnly*/true).first.ToStringAddrPort(), "250.1.1.1:8333");
    BOOST_CHECK_EQUAL(addrman->Select(/*newOnly*/false).first.ToStringAddrPort(), "250.1.1.1:8333");

    // Move address to the tried table
    BOOST_CHECK(addrman->Good(CAddress(addr1, NODE_NONE)));
    BOOST_CHECK_EQUAL(addrman->Size(), 1U);
    auto addr_ret2 = addrman->Select(/*newOnly*/true).first;
    ...
    BOOST_CHECK_EQUAL(addrman->Select(/*newOnly*/true).first.ToStringAddrPort(), "250.3.1.1:8333");
...
{
    auto addrman = std::make_unique<AddrMan>(EMPTY_NETGROUPMAN, DETERMINISTIC, GetCheckRatio(m_node));
    BOOST_CHECK_EQUAL(addrman->Select(/*newOnly*/true, NET_IPV4).first.ToStringAddrPort(), "[::]:0");
    BOOST_CHECK_EQUAL(addrman->Select(/*newOnly*/false, NET_IPV4).first.ToStringAddrPort(), "[::]:0");
    ...
    BOOST_CHECK_EQUAL(addrman->Select(/*newOnly*/true, NET_IPV4).first.ToStringAddrPort(), "250.1.1.1:8333");
    BOOST_CHECK_EQUAL(addrman->Select(/*newOnly*/false, NET_IPV4).first.ToStringAddrPort(), "250.1.1.1:8333");
    BOOST_CHECK_EQUAL(addrman->Select(/*newOnly*/false, NET_IPV6).first.ToStringAddrPort(), "[::]:0");
    BOOST_CHECK_EQUAL(addrman->Select(/*newOnly*/false, NET_ONION).first.ToStringAddrPort(), "[::]:0");
    BOOST_CHECK_EQUAL(addrman->Select(/*newOnly*/false, NET_I2P).first.ToStringAddrPort(), "[::]:0");
    BOOST_CHECK_EQUAL(addrman->Select(/*newOnly*/false, NET_CJDNS).first.ToStringAddrPort(), "[::]:0");
    BOOST_CHECK_EQUAL(addrman->Select(/*newOnly*/false).first.ToStringAddrPort(), "250.1.1.1:8333");
    ...
    BOOST_CHECK_EQUAL(addrman->Select(/*newOnly*/true, NET_I2P).first.ToStringAddrPort(), "udhdrtrcetjm5sxzskjyr5ztpeszydbh4dpl3pl4utgqqw2v4jna.b32.i2p:0");
    BOOST_CHECK_EQUAL(addrman->Select(/*newOnly*/false, NET_I2P).first.ToStringAddrPort(), "udhdrtrcetjm5sxzskjyr5ztpeszydbh4dpl3pl4utgqqw2v4jna.b32.i2p:0");
    BOOST_CHECK_EQUAL(addrman->Select(/*newOnly*/false, NET_IPV4).first.ToStringAddrPort(), "250.1.1.1:8333");
    BOOST_CHECK_EQUAL(addrman->Select(/*newOnly*/false, NET_IPV6).first.ToStringAddrPort(), "[::]:0");
    BOOST_CHECK_EQUAL(addrman->Select(/*newOnly*/false, NET_ONION).first.ToStringAddrPort(), "[::]:0");
    BOOST_CHECK_EQUAL(addrman->Select(/*newOnly*/false, NET_CJDNS).first.ToStringAddrPort(), "[::]:0");
    ...
    BOOST_CHECK_EQUAL(addrman->Select(/*newOnly*/true, NET_I2P).first.ToStringAddrPort(), "[::]:0");
    BOOST_CHECK_EQUAL(addrman->Select(/*newOnly*/false, NET_I2P).first.ToStringAddrPort(), "udhdrtrcetjm5sxzskjyr5ztpeszydbh4dpl3pl4utgqqw2v4jna.b32.i2p:0");
    ...
    BOOST_CHECK_EQUAL(addrman->Select(/*newOnly*/true, NET_I2P).first.ToStringAddrPort(), "c4gfnttsuwqomiygupdqqqyy5y5emnk5c73hrfvatri67prd7vyq.b32.i2p:0");

    // ensure that both new and tried table are selected from
    std::set<std::string> i2p_addrs;
    for (int i = 0; i < 10; ++i) {
        i2p_addrs.insert(addrman->Select(/*newOnly*/false, NET_I2P).first.ToStringAddrPort());
    }
...
BOOST_AUTO_TEST_CASE(addrman_select_special)
{
    ...
    // gets selected even if newOnly is false. if the table was being selected
    // at random, this test will sporadically fail
    BOOST_CHECK_EQUAL(addrman->Select(/*newOnly*/false, NET_IPV4).first.ToStringAddrPort(), "250.1.1.3:8333");
}
